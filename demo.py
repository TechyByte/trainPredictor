...
#import network model, deriving the graph and geospatial data
import network_model
# yields "bare_network_model.pkl"

#import schedule, gathering schedule data (assumed SQL configured correctly)
import schedule

#import incidents data
import incidents

#import compile_historical, gathering historical weather data and saving a populated historical network model to disk
import compile_historical
# yields "historical_model.pkl"

#import learn, training a model on historical data
import learn
# yields "trained_model_whole.h5"

#import predict, making predictions on the model using services
import predict
